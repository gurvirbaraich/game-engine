...
export default class World {
     ...
     */
    public static readonly canvas: HTMLCanvasElement = document.createElement("canvas");
     ...
     */
    public static readonly GL: WebGLRenderingContext = World.canvas.getContext("webgl2");
    ...
    constructor() {
        ...
        if (World.GL == null) {
            const message: string = "WebGL cannot be initialized. Your browser does not support WebGL.";
            alert(message);
